...
#Hamiltonians
H0 = 1*(saa +sbb +scc)
HI = xc.dag()*(sba +sca) +(sba.dag() +sca.dag())*xc
...
# Collects steady state values
def Scully_Populations(i):
    solution2 = mesolve(scully_hamiltonian, psi0, tlist, collapse_ops(i), [xc, nc, saa, sbb, scc])
